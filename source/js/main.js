$(document).ready(function () {
  ...
  function startTimeSalam() {
    ...
    if (hSalam < 4) {
      ucapanSalam = "Selamat Malam Vinkuh"
      kata1 = "Jangan tidur malam";
      kata2 = "Semoga mimpi indah<i class='fa fa-heart'></i>";
    } else {
      if (hSalam < 11) {
        ucapanSalam = "Selamat Pagi Vinkuh🏫"
        kata1 = "Semangat Sekolahnya ya🥰";
        kata2 = "Semoga hari hari mu menyenangkan <i class='fa fa-heart'></i>";
      } else {
        if (hSalam < 16) {
          ucapanSalam = "Selamat Siang Vinkuh"
          kata1 = "Jangan Lupa Istirahat Ya";
          kata2 = "Jangan lupa shalat dzuhur juga<i class='fa fa-heart'></i>";
        } else {
          if (hSalam < 20) {
            ucapanSalam = "Selamat Sore Vinkuh"
            kata1 = "Cape Ya sekolah seharian";
            kata2 = "Yaudah Istirahat aja dulu biar Rileks<i class='fa fa-heart'></i>";
          } else {
              ucapanSalam = "Selamat Malam Vinkuh"
              kata1 = "Jangan tidur malam";
              kata2 = "Semoga mimpi indah<i class='fa fa-heart'></i>";
